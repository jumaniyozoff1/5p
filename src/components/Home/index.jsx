...
import { Container, Wrapper, Img, Icons, CardSection,Card,Title} from './style'
    ...
    return(
        <Wrapper>
            <Title>
                ...
                <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum porro est expedita dolorem suscipit eos, placeat provident </h2>
                <Button width={'150px'} type={'primary'}>Descover More</Button>
            </Title>
            <Icons>
