...
import { Carousel, Container,Wrapper ,Card,Imgs,Border,BorderName} from './style'
...
const Team = () => {
 ...
 const width =  {
  ...
  return (
    <Container >
        <p className='small-description text-centr color'>OUR TEAM MEMBER</p>
        <h1 className='title text-centr'>Meet Our Company Best Team Member.</h1>
