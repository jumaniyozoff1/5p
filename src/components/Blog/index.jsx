...
import { Carousel, Container,Wrapper ,Card,Imgs,Icon,Title,Btn} from './style'
 ...
 const width =  {
  ...
  const items = [
    <Card onDragStart={handleDragStart} role="presentation" >
      <Btn>
      <Button width={'150px'} type={'primary'}>Development</Button>
      </Btn>
      <Imgs  src={Business}/>
      <Title>
        <Title.Description>
          <h1 className='small-description'>Where people develop the own potential</h1>
    ...
    <Card onDragStart={handleDragStart} role="presentation" >
      <Btn>
        <Button className='btns' width={'150px'} type={'primary'}>Development</Button>
      </Btn>
      <Imgs src={Desingn}/>
      <Title>
        <Title.Description>
