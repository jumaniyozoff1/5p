...
const Contact = () => {
  ...
  const {mutate} = useMutation(()=>{
    ...
    body:JSON.stringify({name:nameRef.current.value, componyName:companyNameRef.current.value,phoneNumber:phoneNumberRef.current.value})}) 
    .then(res=>res.json) 
  },
  {
    onSuccess:(res)=>{
    ...
    <Container>
      <Wrapper>
        <Register>
          ...
          <input ref={companyNameRef} placeholder='Familiya' type="text" />
          <input ref={phoneNumberRef} placeholder='Kompaniya yoki firmangiz nomi' type="text" />
